      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full bg-surface border border-border-subtle rounded-2xl py-3 pl-12 pr-4 text-foreground placeholder:text-foreground focus:outline-none focus:ring-2 focus:ring-[#4880FF]/30 transition-all"
          />
        </div>
      </div>
